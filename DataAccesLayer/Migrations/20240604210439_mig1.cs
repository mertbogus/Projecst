            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SCategoryID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SCategoryName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SCategoryDesc = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CategoryID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubCategorys", x => x.SCategoryID);
                });
        }
